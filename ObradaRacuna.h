...
void obradiKupca(KUPAC, KUPAC**);                          //Ovoj funkciji se salje kupac sa obradjenog racuna, niz kupaca i broj proizvoda sa obradjenog racuna
void obradiProizvode_pomocna(int, PROIZVOD**, PROIZVOD*, int);
void obradiMjesec(int, int, MJESEC**, PROIZVOD*, int);                   //Ovoj funkciji se salju mjesec i godina sa obradjenog racuna, niz mjeseci, i kupac sa obradjenog racuna
